...
function WheelModel(props: WheelModelProps) {
  ...
  const tireMaterial = styled ? materials.Rubber : getRubber({ wireframe, color: '#000000' })
  ...
  const capMaterial = styled ? materials.Chrom : getSteel({ wireframe, color })

  return (
    <group {...groupProps}>
      <mesh geometry={tire} material={tireMaterial} castShadow={castShadow} receiveShadow={receiveShadow} />
      <mesh geometry={disc} material={discMaterial} castShadow={castShadow} receiveShadow={receiveShadow} />
      <mesh geometry={cap} material={capMaterial} castShadow={castShadow} receiveShadow={receiveShadow} />
    </group>
  )
}
