  ...
  return (
      ...
      <div className="select-form-control">
        ...
        <div className="select-container">
          ...
          <div id="mutation-chevron-right">
            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} view-box="0 0 24 24" fill="none" stroke="#141414" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="content-block">
      ...
      <div className="car-parameter-container">
        ...
        <div className="footer">
          <div className="parameter">
            <div>Coefficients for engine multivariate linear formula. Given in order x<sub>8</sub>, x<sub>7</sub>, ... , x<sub>0</sub></div>
          </div>
        </div>
      </div>
      <div className="car-parameter-container">
